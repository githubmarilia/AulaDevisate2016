...
namespace AulaDevisate2016 {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class loginDataTable : global::System.Data.TypedTableBase<loginRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public loginRow AddloginRow(string nomecompleto, string login, string senha, int nivel) {
            ...
            private void InitClass() {
                ...
                this.columnnomecompleto.MaxLength = 40;
        ...
        public partial class loginRow : global::System.Data.DataRow {
            ...
            public string nomecompleto {
                get {
                    return ((string)(this[this.tablelogin.nomecompletoColumn]));
                }
                set {
                    this[this.tablelogin.nomecompletoColumn] = value;
                }
            }
            ...
            public int nivel {
                get {
                    return ((int)(this[this.tablelogin.nivelColumn]));
                }
                set {
                    this[this.tablelogin.nivelColumn] = value;
                }
            }
        }
...
namespace AulaDevisate2016.DataSet1TableAdapters {
    ...
    public partial class loginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[login] WHERE (([id] = @Original_id) AND ([nomecompleto] = @Ori" +
                "ginal_nomecompleto) AND ([login] = @Original_login) AND ([senha] = @Original_sen" +
                "ha) AND ([nivel] = @Original_nivel))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[login] ([nomecompleto], [login], [senha], [nivel]) VALUES (@no" +
                "mecompleto, @login, @senha, @nivel);\r\nSELECT id, nomecompleto, login, senha, niv" +
                "el FROM login WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[login] SET [nomecompleto] = @nomecompleto, [login] = @login, [senha] = @senha, [nivel] = @nivel WHERE (([id] = @Original_id) AND ([nomecompleto] = @Original_nomecompleto) AND ([login] = @Original_login) AND ([senha] = @Original_senha) AND ([nivel] = @Original_nivel));
SELECT id, nomecompleto, login, senha, nivel FROM login WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::AulaDevisate2016.Properties.Settings.Default.CnnStr;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, nomecompleto, login, senha, nivel FROM dbo.login";
        ...
        public virtual int Delete(int Original_id, string Original_nomecompleto, string Original_login, string Original_senha, int Original_nivel) {
        ...
        public virtual int Insert(string nomecompleto, string login, string senha, int nivel) {
        ...
        public virtual int Update(string nomecompleto, string login, string senha, int nivel, int Original_id, string Original_nomecompleto, string Original_login, string Original_senha, int Original_nivel, int id) {
            if ((nomecompleto == null)) {
                throw new global::System.ArgumentNullException("nomecompleto");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nomecompleto, string login, string senha, int nivel, int Original_id, string Original_nomecompleto, string Original_login, string Original_senha, int Original_nivel) {
            return this.Update(nomecompleto, login, senha, nivel, Original_id, Original_nomecompleto, Original_login, Original_senha, Original_nivel, Original_id);
        }
    }
